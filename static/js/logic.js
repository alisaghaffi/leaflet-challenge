...
// loop through density intervals and generate a label with a colored square for each interval
    for (i = 0; i < grades.length; i++) {
        div.innerHTML +=
            '<i style="background:' + markerColor(labels[i] + 1) + '"></i> ' +
...
function createMap(earthquakes) {
    ...
    var street = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}?access_token={accessToken}', {
        attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BY-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
        maxZoom: 20,
        accessToken: "pk.eyJ1IjoiYWxleHRlY2hub3N1biIsImEiOiJjbDVqM2tybzkwOGFiM2ZyeXZxdW5pcmo3In0.XdVRGoogpjqXYDHb-TZPXA"
      });
    ...
    var navigation = L.tileLayer('https://api.mapbox.com/styles/v1/mapbox/navigation-day-v1/tiles/{z}/{x}/{y}?access_token={accessToken}', {
        attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery (c) <a href="https://www.mapbox.com/">Mapbox</a>',
        maxZoom: 20,
        accessToken: "pk.eyJ1IjoiYWxleHRlY2hub3N1biIsImEiOiJjbDVqM2tybzkwOGFiM2ZyeXZxdW5pcmo3In0.XdVRGoogpjqXYDHb-TZPXA"
    });
